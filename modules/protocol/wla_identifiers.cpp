 ...
 * per the Architecture wiki page "correctness over purity" -- they keep the original
...
const uint8_t ORB_FLASH wla_announce[] = {
...
const uint8_t ORB_FLASH wla_identify1[] = {
...
const uint8_t ORB_FLASH wla_identify2[] = {
...
const uint8_t ORB_FLASH wla_identify3[] = {
...
const uint8_t ORB_FLASH wla_identify4[] = {
...
const uint8_t ORB_FLASH wla_identify5[] = {
...
const uint8_t ORB_FLASH wla_identify6[] = {0x04, 0xB0, 0x01, 0x03, 0xA2, 0x02, 0x00, 0x00, 0x00};

const uint8_t ORB_FLASH wla_identify7[] = {0x04, 0xA0, 0x01, 0x00, 0xA5, 0x02};
